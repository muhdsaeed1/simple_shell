...
This is an ALX collaboration project( Saheed Olayinka & Paul Mensah ) on Shell ; the shell is builts using c langauge algorithms . The name of the shell is hsh from holberton=h , the shell perform similar tasks as BASH .
